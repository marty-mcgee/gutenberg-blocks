...
registerBlockType("wcn/testimonial-slider", {
  ...
  edit: props => {
	...
	const testimonialsList = testimonials
	  ...
	  .map(testimonial => {
		return (
		  <div className="wcn-testimonial-block">
			<p>
			  <span>
			...
			<blockquote className="wp-block-quote">
			  ...
			  />
			  <div className="row">
				<div className="wcn__picture col-3">
				  <MediaUpload
					onSelect={media => {
					...
					render={({ open }) =>
					  !!testimonial.image ? (
						<div>
						  {props.isSelected && (
							<div className="wcn__picture__actions">
							  <a
								href="#"
								onClick={() => {
